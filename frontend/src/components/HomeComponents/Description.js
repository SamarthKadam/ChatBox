...
export default function Description() {
  ...
  return (
    <div className=' h-[85%] grid grid-cols-2 gap-4 max-[1400px]:grid-cols-[4fr,5fr] max-[1300px]:grid-cols-[3fr,5fr] max-[1127px]:grid-rows-2  max-[1127px]:grid-cols-[1fr] max-[451px]:grid-cols-1'>
        ...
        <p className='mt-10 mb-6 text-white text-lg font-semibold font-Roboto text-center'>The easiest & fasted way to live chat</p>
        <Banner></Banner>
        </div>
        <div className='relative'>
            <div className="absolute max-[451px]:top-[0%] w-[50%] top-[20%] translate-y-[-20%] left-[95%] z-[555] translate-x-[-95%] max-[1127px]:top-[-15%]">
              {menChat.map((val,ind)=>{
                return(
            ...
            <div className='absolute max-[451px]:top-[70%] w-[50%] top-[68%] translate-y-[-68%]  left-[15%]  z-[87]  translate-x-[-15%] max-[1127px]:top-[78%]'>
            ...
            <img alt='men pic' className="w-[55%] rounded-[20px] absolute top-[20%] z-50 max-[1127px]:top-[-15%]   max-[451px]:top-[20%]" src={MenImage}></img>
            <img alt='women pic' className="w-[55%] rounded-[20px] absolute top-[54%] z-30 left-[95%] max-[1127px]:top-[30%]  translate-x-[-95%]  max-[451px]:top-[55%]" src={WomenImage}></img>
