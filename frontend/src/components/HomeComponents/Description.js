...
export default function Description() {
  ...
  return (
    <div className=' h-[85%] grid grid-cols-2 gap-4 max-[1400px]:grid-cols-[4fr,5fr] max-[1300px]:grid-cols-[3fr,5fr] max-[1127px]:grid-rows-2  max-[1127px]:grid-cols-[1fr] max-[451px]:grid-rows-1'>
      <div className='desca flex flex-col justify-center items-start'>
        <div className='desca1 text-white text-5xl font-semibold font-Poppins  max-[1300px]:text-3xl max-[1127px]:text-5xl max-[607px]:text-4xl'>Chat easy , chat instantly wherever you go</div>
        <p className='desc mt-2 text-white text-lg font-Roboto'>The easiest & fasted way to live chat</p>
        
        <div className='home-login'>
          <br />
          <a href="#" className="btn btn-primary active mx-3">login</a>
          <span className='btn btn-light '>OR</span>
          <a href="#" className="btn btn-secondary active mx-2">SignUp</a>
        </div>
        <Banner></Banner>
      </div>
