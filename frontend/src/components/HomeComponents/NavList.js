...
export default function NavList() {
  ...
  return (
    <div>
      <div class="menulinks duration-500 md:static md:min-h-fit absolute min-h-[28vh] left-[0%] top-[-100%] md:w-auto w-[100%] flex justify-center py-5 fixed  md:bg-transparent bg-gray-800">
