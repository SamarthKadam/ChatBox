...
export default function Chat({message,isMale}) {
  ...
  return (
    <MotionAnimate animation="fadeInUp">
       {isMale&&<div className='bg-[#FFAF3A] max-[1500px]:text-sm max-[528px]:text-xs rounded-t-[10px] rounded-br-[20px] px-[5%] py-[4%] my-[19%] text-black font-Roboto font-bold'>{message}</div>}
