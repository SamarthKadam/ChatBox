...
export default function ChatBar({data,select}) {
  ...
  return (
    ...
    <Avatar alt="User-pic" referrerPolicy="no-referrer" sx={{width:48,height:48}} src={isGroupChat?groupLogo:(user.pic.startsWith('user')?`http://127.0.0.1:4000/${user.pic}`:user.pic)} />
