...
export default function ChatBar({data,select}) {
  ...
  return (
    <div style={{backgroundColor:val&&val._id===data._id?'#F3F4F6':null}} onClick={select.bind(this,data)} className=' flex flex-row items-center justify-between max-[900px]:justify-center rounded-md cursor-pointer mx-[2%] my-[5%] hover:bg-gray-100 px-[5%] py-[2%]'>
    ...
    <div className='flex  max-[900px]:hidden flex-col ml-2'>
      ...
      <div className='flex flex-col items-end'>
        <div className='text-xs max-[900px]:hidden font-medium cursor-pointer text-[#979797]' >{`${String(dateObject.getHours()%12).padStart(2,'0')}:${String(dateObject.getMinutes()).padStart(2,'0')} ${dateObject.getHours()>=12?'PM':'AM'}`}</div>
        <div className='mt-1'>
...
//max-[900px]:justify-center added to line 31 --> Center the user pic on mobile screen
//max-[900px]:hidden  added to line 39 --> Hide the user name
//max-[900px]:hidden  added to line 39 --> Hide the time