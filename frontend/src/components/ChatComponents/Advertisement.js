...
export default function Advertisement() {
  return (
    <div className='h-[100%] w-[100%] flex flex-col justify-center items-center'>
      ...
      <a href='http://127.0.0.1:4000/api/v1/download' download='file.exe' className="px-4 py-2 max-[1250px]:px-3 max-[1250px]:py-1 bg-[#5080FE] mt-4 text-white rounded-3xl transition hover:bg-[#0147FF] cursor-pointer">Get the app</a>
    </div>
  )
}
