...
export default function Advertisement() {
  return (
    <div className={`${GetMode()}-adv h-[100%] w-[100%] flex flex-col justify-center items-center`}>
      ...
      <div className={`${GetMode()}-adv-dwn text-3xl font-semibold max-[1250px]:text-2xl font-Roboto tracking-normal`}>Download ChatBox for Windows</div>
