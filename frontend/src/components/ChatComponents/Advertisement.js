...
export default function Advertisement() {
  return (
    <div className='dark:bg-gray-700 h-[100%] w-[100%] flex flex-col justify-center items-center'>  
      ...
      <div className='dark:text-gray-100 text-3xl font-semibold max-[1250px]:text-2xl font-Roboto tracking-normal'>Download ChatBox for Windows</div>
      <div className='dark:text-gray-200 w-[50%] mt-4 text-center text-[#8696A0] font-Poppins text-sm'>Experience lightning-fast messaging on your Windows device with our app.</div>
