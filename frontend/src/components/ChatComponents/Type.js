...
export default function Type() {
  ...
  return (
    <div className="border-[1px] border-[#f5f5f5] bg-[#FFFFFF] h-[12%] flex flex-row justify-center items-center relative">
      ...
      <textarea spellCheck="false"  data-gramm="false" type='text' placeholder='Type a message' className=' bg-gray-100 font-Roboto box-border px-[5%] flex  text-md w-[95%] py-[1%] outline-none h-[70%] rounded-3xl'>
      </textarea>
    </div>
  )
}