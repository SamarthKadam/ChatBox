...
<br />
<hr></hr>
<form className='dark:text-black mt-6 relative dark:bg-gray-900 '>
  ...
  <Typography className='text-center py-3 dark:text-gray-200'>Already have and account ? <Link className='text-blue-600' to="/login">LogIn</Link></Typography>
