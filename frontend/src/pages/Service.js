...
export default function Service() {
  return (
    ...
    <div className='flex flex-col items-center'>
      ...
      <div className='text-[#384055] text-6xl text-center font-semibold font-Poppins max-[1127px]:text-5xl max-[607px]:text-4xl dark:text-white'>Get the best of all the features</div>
      </div>
      <div className=" dark:text-[#202635] mt-[10%] w-[70vw] max-[653px]:gap-4 grid grid-cols-2 gap-10">
