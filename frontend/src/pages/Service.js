...
export default function Service() {
  return (
    ...
    <div className='flex flex-col items-center'>
      <div className='w-[60%]'>
      <div className='text-[#384055] text-6xl text-center mt-20 md:mt-0 font-semibold font-Poppins max-[1127px]:text-5xl max-[607px]:text-4xl'>Get the best of all the features</div>
      </div>
