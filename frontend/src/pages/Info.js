...
export default function Info() {
  return (
    ...
    <div className={`${GetMode()}-dwbprder border-[1px] border-[#f5f5f5]`}></div>
    <div className={`${GetMode()}-upbprder border-[1px] border-[#f5f5f5]`}>
    <div className="px-[5%] py-[2%]">
          <div className={`${GetMode()}-heading font-Poppins max-[1024px]:text-xl font-semibold text-2xl`}>
            About
          </div>
          <div className='mt-[2%] flex flex-col gap-4'>
          <div className=' flex flex-col'>
            <div className={`${GetMode()}-heading font-Poppins max-[1024px]:text-sm font-bold `}>
              Build Version
            </div>
