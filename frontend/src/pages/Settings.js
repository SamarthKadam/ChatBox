...
export default function Settings() {
  ...
  return (
    <div className="dark:bg-gray-800 dark:text-gray-200 grid w-[80vw] relative grid-rows-[1fr,7fr] ">
      <ThemeSwitcher/>
        ...
        <div className="px-[5%] py-[2%]">
          ...
          <div className="flex flex-row mt-[2%] gap-2">
            <div
              ...
              className="dark:bg-blue-900 dark:hover:bg-[#20226d]  bg-[#202142] hover:bg-[#202162] text-white font-medium  cursor-pointer border-[#000000]  px-4 py-2 max-[1024px]:px-2 max-[1024px]:py-1 max-[1024px]:text-sm rounded-md font-Roboto tracking-tight"
            >
              Update
            </div>
            <div
              onClick={resetData}
              className="dark:text-gray-800 bg-[#C6CED1] text-white font-medium  cursor-pointer border-[#000000]  px-4 py-2 rounded-md font-Roboto tracking-tight max-[1024px]:px-2 max-[1024px]:py-1 max-[1024px]:text-sm"
            >
              Reset
            </div>
          </div>
